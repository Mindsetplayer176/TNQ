const data =
    [{
        ...
        "successful_landings": null,
        "attempted_landings": null,
        "attempted_catches": null,
        "successful_catches": null,
        "missions": [{
        ...
        "successful_landings": null,
        "attempted_landings": null,
        "attempted_catches": 12,
        "successful_catches": 3,
        "missions": [{
            "name": "KoreaSat 5A",
            "flight": 50
        }, {
        ...
        "url": "https://www.marinetraffic.com/en/ais/details/ships/shipid:430344",
        "image": "https://photos.marinetraffic.com/ais/showphoto.aspx?photoid=3406596"
    }, {
        "ship_id": "JRTI-1",
        "ship_name": "Just Read The Instructions 1",
        ...
        "ship_id": "JRTI-2",
        "ship_name": "Just Read The Instructions 2",
        ...
        "ship_model": null,
        "ship_type": "Cargo",
        "roles": ["Support Ship", "Dragon Recovery"],
        "active": true,
        "imo": 9271195,
        "mmsi": 367486370,
        "abs": 1134613,
...
search.addEventListener("keyup", (e) => {
  ...
  const search = data.filter((ele) => {
       return ele.ship_name[0].toLowerCase().includes(searchval);
  });
  console.log(search); 
});